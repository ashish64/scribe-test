                ...
                <li class="tocify-item level-1" data-unique="endpoints">
                    <a href="#endpoints">Endpoints</a>
                                ...
                                <a href="#endpoints-POSTapi-register">POST api/register</a>
                                                                                ...
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-authUser">
                                <a href="#endpoints-GETapi-authUser">GET api/authUser</a>
                            </li>
                                                                        </ul>
                            </ul>
                ...
                <li class="tocify-item level-1" data-unique="user-endpoints">
                    <a href="#user-endpoints">User endpoints</a>
                                    ...
                                    <ul id="tocify-subheader-user-endpoints" class="tocify-subheader">
                                                    <li class="tocify-item level-2" data-unique="user-endpoints-GETapi-v1-users">
                                <a href="#user-endpoints-GETapi-v1-users">GET api/v1/users</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="user-endpoints-GETapi-v1-users--id-">
                                <a href="#user-endpoints-GETapi-v1-users--id-">GET api/v1/users/{id}</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="user-endpoints-PUTapi-v1-users--id-">
                                <a href="#user-endpoints-PUTapi-v1-users--id-">PUT api/v1/users/{id}</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="user-endpoints-DELETEapi-v1-users--id-">
                                <a href="#user-endpoints-DELETEapi-v1-users--id-">DELETE api/v1/users/{id}</a>
                            </li>
                                                                        </ul>
                            </ul>
            </div>
...
const headers = {
    "Authorization": "Bearer fa8E54b6ah1gdP3kZV6Dvce",
...
&nbsp;
 &nbsp;
               ...
               value="Bearer fa8E54b6ah1gdP3kZV6Dvce"
               data-component="header">
    <br>
<p>Example: <code>Bearer fa8E54b6ah1gdP3kZV6Dvce</code></p>
            </div>
                                <div style="padding-left: 28px; clear: unset;">
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               value="vhessel@example.org"
               data-component="body">
    <br>
<p>Email address for the user. Must be a valid email address. Example: <code>vhessel@example.org</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Password for the user. Example: <code>Yh&amp;%xQ</code></p>
        </div>
        </form>
...
const headers = {
    "Authorization": "Bearer E6a8hPeVbZc53Dfk4av6d1g",
    "Content-Type": "application/json",
    "Accept": "application/json",
};
...
&nbsp;
 &nbsp;
               ...
               value="Bearer E6a8hPeVbZc53Dfk4av6d1g"
               data-component="header">
    <br>
<p>Example: <code>Bearer E6a8hPeVbZc53Dfk4av6d1g</code></p>
            </div>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-GETapi-authUser">GET api/authUser</h2>
...
<span id="example-requests-GETapi-authUser">
<blockquote>Example request:</blockquote>


<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost/api/authUser"
);

const headers = {
    "Authorization": "Bearer kZvbVde458hE3P6f1aacg6D",
    "Content-Type": "application/json",
    "Accept": "application/json",
};
...
<div class="php-example">
    <pre><code class="language-php">$client = new \GuzzleHttp\Client();
$url = 'http://localhost/api/authUser';
$response = $client-&gt;get(
    $url,
    [
        'headers' =&gt; [
...
<span id="example-responses-GETapi-authUser">
            <blockquote>
...
<span id="execution-results-GETapi-authUser" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-authUser"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-authUser"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-authUser" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-authUser">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-authUser" data-method="GET"
      data-path="api/authUser"
      data-authed="1"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-authUser', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-authUser"
                    onclick="tryItOut('GETapi-authUser');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-authUser"
                    onclick="cancelTryOut('GETapi-authUser');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-authUser"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="GETapi-authUser"
               value="Bearer kZvbVde458hE3P6f1aacg6D"
               data-component="header">
    <br>
<p>Example: <code>Bearer kZvbVde458hE3P6f1aacg6D</code></p>
            </div>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-authUser"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-authUser"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
                ...
                <h1 id="user-endpoints">User endpoints</h1>
                                ...
                                <h2 id="user-endpoints-GETapi-v1-users">GET api/v1/users</h2>
...
const headers = {
    "Authorization": "Bearer Ph8bVa4Eva3D6Zkf61egd5c",
    "Content-Type": "application/json",
    "Accept": "application/json",
};
...
&nbsp;
 &nbsp;
               ...
               value="Bearer Ph8bVa4Eva3D6Zkf61egd5c"
               data-component="header">
    <br>
<p>Example: <code>Bearer Ph8bVa4Eva3D6Zkf61egd5c</code></p>
            </div>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="user-endpoints-GETapi-v1-users--id-">GET api/v1/users/{id}</h2>
...
const headers = {
    "Authorization": "Bearer fa5ZbV4a61hD63dEkeg8cPv",
    "Content-Type": "application/json",
    "Accept": "application/json",
};
...
&nbsp;
 &nbsp;
               ...
               value="Bearer fa5ZbV4a61hD63dEkeg8cPv"
               data-component="header">
    <br>
<p>Example: <code>Bearer fa5ZbV4a61hD63dEkeg8cPv</code></p>
            </div>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
...
<p>The ID of the user. Example: <code>1</code></p>
                    ...
                    <h2 id="user-endpoints-PUTapi-v1-users--id-">PUT api/v1/users/{id}</h2>
...
const headers = {
    "Authorization": "Bearer abVhvDc5geE1ZdP8a6k364f",
    "Content-Type": "application/json",
    "Accept": "application/json",
};
...
&nbsp;
 &nbsp;
               ...
               value="Bearer abVhvDc5geE1ZdP8a6k364f"
               data-component="header">
    <br>
<p>Example: <code>Bearer abVhvDc5geE1ZdP8a6k364f</code></p>
            </div>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Users name. Must not be greater than 255 characters. Example: <code>lfqjfdihdyvwy</code></p>
        </div>
        </form>

                    <h2 id="user-endpoints-DELETEapi-v1-users--id-">DELETE api/v1/users/{id}</h2>
...
const headers = {
    "Authorization": "Bearer 48k5hb6a1ZPf6Dc3VevdgEa",
    "Content-Type": "application/json",
    "Accept": "application/json",
};
...
&nbsp;
 &nbsp;
               ...
               value="Bearer 48k5hb6a1ZPf6Dc3VevdgEa"
               data-component="header">
    <br>
<p>Example: <code>Bearer 48k5hb6a1ZPf6Dc3VevdgEa</code></p>
            </div>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
